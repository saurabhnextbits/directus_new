import { resolveComponent, openBlock, createBlock, withCtx, createVNode, createElementVNode, createCommentVNode, createTextVNode } from 'vue';
...
var script = {
	...
	methods: {
    startDateUpdate(e){
      this.timeOff.start_date = e;
    },
    endDateUpdate(e){
      this.timeOff.end_date = e;
    },
    formValidate(){
      this.error = "";
    ...
    dialogSubmit(){
      // if(this.formValidate()){
        ...
        this.timeOff.id = Date.now() + parseInt(Math.random()*100);
                
        this.api.post(`/items/time_off_request`,
        {
          start_date : this.timeOff.start_date,
          end_date : this.timeOff.end_date,
          full_or_half_day : this.timeOff.full_or_half_day,
          reason : this.timeOff.reason,
          project : this.timeOff.project,
          status: "published"
        }).then(function (response) {
            console.log(response.data.data);
            axios$1.get(`https://script.google.com/macros/s/AKfycbzCWXM73YwaU5-XMIWGW3O_7ibnX1S_91bXAYf0h8CjCb8cAfS72OjLsERngnbyX18/exec`, {
              params: response.data.data
            })
            .then(function (res) {
              console.log(res);
              that.success = 'Form Submitted Successfully';
              setTimeout(function(){
                that.success = '';
              },10000);
            })
...
const _hoisted_1 = { class: "field full" };
const _hoisted_2 = ["innerHTML"];
const _hoisted_3 = ["innerHTML"];
const _hoisted_4 = { class: "field full" };
const _hoisted_5 = { class: "task-date-wrapper" };
const _hoisted_6 = { class: "date-input" };
const _hoisted_7 = { class: "field full" };
const _hoisted_8 = { class: "task-date-wrapper" };
const _hoisted_9 = { class: "date-input" };
const _hoisted_10 = { class: "field full" };
const _hoisted_11 = { class: "field full" };
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_private_view, { title: "TimeOff Request" }, {
    ...
    default: withCtx(() => [
      createElementVNode("form", null, [
        ...
        createElementVNode("div", _hoisted_4, [
          createVNode(_component_v_text_overflow, { text: "Start Date" }),
          createElementVNode("div", _hoisted_5, [
            createVNode(_component_v_input, {
              type: "text",
              style: {"width":"90%"},
              modelValue: $data.timeOff.start_date,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => (($data.timeOff.start_date) = $event)),
              placeholder: "--"
              ...
              default: withCtx(() => [
                createElementVNode("div", _hoisted_6, [
                  createVNode(_component_v_date_picker, {
                    type: "date",
                    "model-value": $data.timeOff.start_date,
                    "onUpdate:modelValue": $options.startDateUpdate,
        ...
        createElementVNode("div", _hoisted_7, [
          createVNode(_component_v_text_overflow, { text: "End Date" }),
          createElementVNode("div", _hoisted_8, [
            createVNode(_component_v_input, {
              type: "text",
              style: {"width":"90%"},
              modelValue: $data.timeOff.end_date,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => (($data.timeOff.end_date) = $event)),
              placeholder: "--"
            }, null, 8 /* PROPS */, ["modelValue"]),
            createVNode(_component_v_menu, {
              ref: "date",
              ...
              default: withCtx(() => [
                createElementVNode("div", _hoisted_9, [
                  createVNode(_component_v_date_picker, {
                    type: "date",
                    "model-value": $data.timeOff.end_date,
                    "onUpdate:modelValue": $options.endDateUpdate,
                    style: {"min-width":"300px"}
                  }, null, 8 /* PROPS */, ["model-value", "onUpdate:modelValue"])
                ])
              ]),
        ...
        createElementVNode("div", _hoisted_10, [
          createVNode(_component_v_text_overflow, { text: "Full or Half Day" }),
          createVNode(_component_v_select, {
            label: "Full or Half Day",
            filled: "",
            modelValue: $data.timeOff.full_or_half_day,
            "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => (($data.timeOff.full_or_half_day) = $event)),
            items: ['Full Day','Half Day']
          }, null, 8 /* PROPS */, ["modelValue"])
        ]),
        createElementVNode("div", _hoisted_11, [
          createVNode(_component_v_text_overflow, { text: "Reason" }),
          createVNode(_component_v_textarea, {
            modelValue: $data.timeOff.reason,
            "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => (($data.timeOff.reason) = $event))
          }, null, 8 /* PROPS */, ["modelValue"])
        ]),
        createVNode(_component_v_button, {
          class: "field full",
